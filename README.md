...
* 🌱 **Currently Exploring:** Bridging the gap between hands-on software development and high-level project management, while leveraging AI productivity tools and containerization (Docker/Kubernetes).
